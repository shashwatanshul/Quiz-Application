const pizzas = [
  {
    ...
    description:
      "A tasty blend of spices, the succulence of chicken, the crispy crusts, and the stringy cheese – this is what you will get if you decide to indulge in the deliciousness of this particular pizza.",
  },
  {
    ...
    description:
      "Bite into supreme delight of Black Olives, Onions, Grilled Mushrooms, Pepper BBQ Chicken, Peri-Peri Chicken and Grilled Chicken Rashers",
  },
  {
    ...
    category: "veg",
    description:
      "Corn over the base makes it looks beautiful. It is served with tomato sauce and chili flakes are sprinkled",
    image: "https://www.dominos.co.in//files/items/Corn_&_Cheese.jpg",
  },
  {
    name: "Jalapeno & Red Paprika",
    varients: ["small", "medium", "large"],
    prices: [
      {
        small: 200,
    ...
    description:
      "This pizza has Jalepeno & Red Peprika and can become more delicious if we will add some more cheese in it.",
  },
  {
    name: "Margherita",
    varients: ["small", "medium", "large"],
